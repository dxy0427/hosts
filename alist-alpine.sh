...
install_alist_binary() {
    ...
    if [ -n "$proxy_input" ]; then
        gh_download_url="${proxy_input}https://github.com/alist-org/alist/releases/latest/download/$ALIST_FILE"
        echo -e "${GREEN_COLOR}使用代理地址: $proxy_input${RES}"
    else
        gh_download_url="https://github.com/alist-org/alist/releases/latest/download/$ALIST_FILE"
...
do_update_alist() {
    ...
    if [ -n "$download_proxy_url" ]; then
        gh_download_url="${download_proxy_url}https://github.com/alist-org/alist/releases/download/${latest_version}/$gh_download_url_versioned_alist_file"
    else
        gh_download_url="https://github.com/alist-org/alist/releases/download/${latest_version}/$gh_download_url_versioned_alist_file"
    fi
...
do_auto_update_alist() {
    ...
    if [ -n "$download_proxy_for_auto_update" ]; then
        ...
        gh_download_url="${download_proxy_for_auto_update}https://github.com/alist-org/alist/releases/download/${latest_version}/$gh_download_url_versioned_alist_file"
    else
        gh_download_url="https://github.com/alist-org/alist/releases/download/${latest_version}/$gh_download_url_versioned_alist_file"
    fi
